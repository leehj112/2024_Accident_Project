...
#맑음       
    ...
    if rainfall>50 and current_temperature<0 :
        ...
        road_surface='서리/결빙' 
    elif 1<rainfall and current_temperature>0:
        road_surface='젖음/습기'
    elif rainfall>50 and current_tempertaure>0:
        road_surface='젖음/습기'
    elif 0<=rainfall<1 and humidity!=100:
        road_surface='건조'
    else:
        road_surface='기타'
#흐림       
...
print("현재날씨:",weather_result(weather))
