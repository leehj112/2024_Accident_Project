...
#   >>> cd (파일저장경로)
#   >>> streamlit run 240516_1400_The-elderly-driver-traffic-accidents_suwon.py
###############################################################################
# 라이브러리
import pandas as pd
...
gu_risk = pd.DataFrame({'위험지수' : [0.0,0.0,0.0,0.0]}, index=gu_list)

# ## '구'별 위험지수, 날씨, 온도, 습도, 강수량, 주야간, 노면상태, 기상상태 테이블 생성
for gu in gu_list :
    # 기상청 데이터 호출
